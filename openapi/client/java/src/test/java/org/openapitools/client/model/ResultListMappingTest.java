...
/**
 * Model tests for ResultListMapping
 */
public class ResultListMappingTest {
    private final ResultListMapping model = new ResultListMapping();
