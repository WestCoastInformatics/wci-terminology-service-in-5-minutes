...
// checks if the ResultListSubset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultListSubset{}

// ResultListSubset struct for ResultListSubset
type ResultListSubset struct {
...
func (o ResultListSubset) MarshalJSON() ([]byte, error) {
...
func (o ResultListSubset) ToMap() (map[string]interface{}, error) {
...
type NullableResultListSubset struct {
	value *ResultListSubset
	isSet bool
}

func (v NullableResultListSubset) Get() *ResultListSubset {
	return v.value
}

func (v *NullableResultListSubset) Set(val *ResultListSubset) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListSubset) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListSubset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListSubset(val *ResultListSubset) *NullableResultListSubset {
	return &NullableResultListSubset{value: val, isSet: true}
}

func (v NullableResultListSubset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListSubset) UnmarshalJSON(src []byte) error {
	v.isSet = true
