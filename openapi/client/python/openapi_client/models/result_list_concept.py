...
class ResultListConcept(BaseModel):
    """
    ResultListConcept
    """
    ...
    items: conlist(Concept) = Field(..., description="the items themselves (the format will vary depending on the type of list)")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultListConcept:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultListConcept:
        """Create an instance of ResultListConcept from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultListConcept.parse_obj(obj)

        _obj = ResultListConcept.parse_obj({
            "total": obj.get("total"),
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "confidence": obj.get("confidence"),
            "items": [Concept.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
