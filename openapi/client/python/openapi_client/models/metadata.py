...
class Metadata(BaseModel):
    ...
    """
    type: StrictStr = Field(..., description="the type of metadata")
    abbreviation: StrictStr = Field(..., description="the label for the metadata element")
    rank: Optional[StrictInt] = Field(None, description="used for when metadata lists need to be ranked (as in a ranked list of term types)")
    ...
    __properties = ["type", "abbreviation", "rank", "name", "terminology", "attributes", "created", "local", "modifiedBy", "modified", "id", "active"]
