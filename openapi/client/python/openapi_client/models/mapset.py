...
class Mapset(BaseModel):
    ...
    mapped_to_terminology: StrictStr = Field(..., alias="mappedToTerminology", description="the target terminology of this map set")
    ...
    __properties = ["code", "mappedToTerminology", "created", "local", "modifiedBy", "modified", "id", "active", "name", "terminology", "attributes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Mapset:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Mapset:
        """Create an instance of Mapset from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Mapset.parse_obj(obj)

        _obj = Mapset.parse_obj({
            "code": obj.get("code"),
            "mapped_to_terminology": obj.get("mappedToTerminology"),
