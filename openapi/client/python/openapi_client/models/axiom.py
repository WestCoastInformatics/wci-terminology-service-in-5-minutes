...
class Axiom(BaseModel):
    ...
    __properties = ["code", "value", "created", "local", "modifiedBy", "modified", "id", "active", "terminology"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Axiom:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Axiom:
        """Create an instance of Axiom from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Axiom.parse_obj(obj)

        _obj = Axiom.parse_obj({
            "code": obj.get("code"),
            "value": obj.get("value"),
