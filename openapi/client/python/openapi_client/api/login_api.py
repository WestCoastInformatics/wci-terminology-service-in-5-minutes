...
class LoginApi:
    ...
    @validate_arguments
    def auth(self, auth_request : Annotated[AuthRequest, Field(..., description="Authorization information")], **kwargs) -> AuthResponse:  # noqa: E501
        """Login  # noqa: E501
        ...
        :param auth_request: Authorization information (required)
        ...
        return self.auth_with_http_info(auth_request, **kwargs)  # noqa: E501

    @validate_arguments
    def auth_with_http_info(self, auth_request : Annotated[AuthRequest, Field(..., description="Authorization information")], **kwargs) -> ApiResponse:  # noqa: E501
        """Login  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.auth_with_http_info(auth_request, async_req=True)
        >>> result = thread.get()
