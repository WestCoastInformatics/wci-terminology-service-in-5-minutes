...
from openapi_client.models.concept_relationship import ConceptRelationship  # noqa: E501
...
class TestConceptRelationship(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConceptRelationship:
        """Test ConceptRelationship
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConceptRelationship`
        """
        model = ConceptRelationship()  # noqa: E501
        if include_optional:
