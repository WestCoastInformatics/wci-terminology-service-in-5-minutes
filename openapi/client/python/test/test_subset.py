...
from openapi_client.models.subset import Subset  # noqa: E501

class TestSubset(unittest.TestCase):
    """Subset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Subset:
        """Test Subset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Subset`
        """
        model = Subset()  # noqa: E501
        if include_optional:
            return Subset(
