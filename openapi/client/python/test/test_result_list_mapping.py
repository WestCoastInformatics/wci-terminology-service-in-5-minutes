...
from openapi_client.models.result_list_mapping import ResultListMapping  # noqa: E501

class TestResultListMapping(unittest.TestCase):
    """ResultListMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultListMapping:
        """Test ResultListMapping
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultListMapping`
        """
        model = ResultListMapping()  # noqa: E501
        if include_optional:
    ...
    def testResultListMapping(self):
        """Test ResultListMapping"""
