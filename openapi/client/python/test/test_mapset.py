...
from openapi_client.models.mapset import Mapset  # noqa: E501

class TestMapset(unittest.TestCase):
    """Mapset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Mapset:
        """Test Mapset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Mapset`
        """
        model = Mapset()  # noqa: E501
        if include_optional:
            return Mapset(
