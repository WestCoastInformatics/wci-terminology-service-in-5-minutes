...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.Mapset();
  });
  ...
  describe('Mapset', function() {
    it('should create an instance of Mapset', function() {
      // uncomment below and update the code to test Mapset
      //var instance = new WestCoastInformaticsTerminologyApi.Mapset();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.Mapset);
    });
    ...
    it('should have the property mappedToTerminology (base name: "mappedToTerminology")', function() {
      // uncomment below and update the code to test the property mappedToTerminology
      //var instance = new WestCoastInformaticsTerminologyApi.Mapset();
      //expect(instance).to.be();
    });
