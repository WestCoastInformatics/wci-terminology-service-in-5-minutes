...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.Subset();
  });
  ...
  describe('Subset', function() {
    it('should create an instance of Subset', function() {
      // uncomment below and update the code to test Subset
      //var instance = new WestCoastInformaticsTerminologyApi.Subset();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.Subset);
    });
