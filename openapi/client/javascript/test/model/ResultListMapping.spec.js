...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.ResultListMapping();
  });
  ...
  describe('ResultListMapping', function() {
    it('should create an instance of ResultListMapping', function() {
      // uncomment below and update the code to test ResultListMapping
      //var instance = new WestCoastInformaticsTerminologyApi.ResultListMapping();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.ResultListMapping);
    });
