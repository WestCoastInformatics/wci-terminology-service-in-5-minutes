...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.ResultListConcept();
  });
  ...
  describe('ResultListConcept', function() {
    it('should create an instance of ResultListConcept', function() {
      // uncomment below and update the code to test ResultListConcept
      //var instance = new WestCoastInformaticsTerminologyApi.ResultListConcept();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.ResultListConcept);
    });
