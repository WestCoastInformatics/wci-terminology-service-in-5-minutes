...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.ResultListConceptTreePosition();
  });
  ...
  describe('ResultListConceptTreePosition', function() {
    it('should create an instance of ResultListConceptTreePosition', function() {
      // uncomment below and update the code to test ResultListConceptTreePosition
      //var instance = new WestCoastInformaticsTerminologyApi.ResultListConceptTreePosition();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.ResultListConceptTreePosition);
    });
