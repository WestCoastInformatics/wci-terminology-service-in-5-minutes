...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.Axiom();
  });
  ...
  describe('Axiom', function() {
    it('should create an instance of Axiom', function() {
      // uncomment below and update the code to test Axiom
      //var instance = new WestCoastInformaticsTerminologyApi.Axiom();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.Axiom);
    });
