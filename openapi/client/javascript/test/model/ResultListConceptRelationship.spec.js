...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestCoastInformaticsTerminologyApi.ResultListConceptRelationship();
  });
  ...
  describe('ResultListConceptRelationship', function() {
    it('should create an instance of ResultListConceptRelationship', function() {
      // uncomment below and update the code to test ResultListConceptRelationship
      //var instance = new WestCoastInformaticsTerminologyApi.ResultListConceptRelationship();
      //expect(instance).to.be.a(WestCoastInformaticsTerminologyApi.ResultListConceptRelationship);
    });
